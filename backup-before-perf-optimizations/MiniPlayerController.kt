...
object MiniPlayerController {
    ...
    /**
     * Non-blocking stop: detaches the player immediately (no ExoPlayer.stop() on main thread)
     * and resets state to Idle. The detached player will be released later in onPause.
     * Use this when navigating to fullscreen to avoid ANR on slow devices.
     */
    /** True while a transition to fullscreen is in progress — prevents onPause cleanup */
