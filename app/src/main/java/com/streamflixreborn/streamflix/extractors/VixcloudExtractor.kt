...
// 2026-07-23 : importé depuis streamflix-reborn (upstream). Player/CDN vixcloud.co,
//   utilisé par la famille VixSrc (StreamingCommunity). Compatible avec notre fork
//   (NetworkClient présent). Domaine distinct de VixSrcExtractor (vixsrc.to) → aucun
//   chevauchement de routage.
