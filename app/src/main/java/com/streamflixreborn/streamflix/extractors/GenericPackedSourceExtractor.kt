...
// 2026-07-23 : importé depuis streamflix-reborn (upstream). Base générique pour les
//   players en JS « packed » (eval(p,a,c,k,e,d)) : déballe le script, suit les
//   redirections méta/JS, extrait le m3u8/mp4. Fournit 5 extracteurs concrets
//   (StreamSB, Mp4Upload, Streamlare, NinjaStream, Uch). Deps présentes dans notre
//   fork (JsUnpacker, DnsResolver, rotatingDomain). Aucun chevauchement de domaine.
