...
// 2026-07-23 : importé depuis streamflix-reborn (upstream). Player anime megaplay/vidtube
//   (famille anikototv). ⚠️ ADAPTATION : l'alias upstream « vidwish.live » est RETIRÉ —
//   il entrerait en collision de routage avec StreamWishExtractor (alias « vidwish.site »,
//   même base « vidwish » via le matcher secondaire) et risquerait de lui voler des liens.
//   On garde vidtube.site (principal) + megaplay.buzz (aucune collision).
